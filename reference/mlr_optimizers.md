...
[Optimizer](https://bbotk.mlr-org.com/reference/Optimizer.md). Each
...
[`opt()`](https://bbotk.mlr-org.com/reference/opt.md)/[`opts()`](https://bbotk.mlr-org.com/reference/opt.md).
...
Sugar functions: [`opt()`](https://bbotk.mlr-org.com/reference/opt.md),
[`opts()`](https://bbotk.mlr-org.com/reference/opt.md)
