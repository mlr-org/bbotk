...
[Terminator](https://bbotk.mlr-org.com/reference/Terminator.md). Each
terminator has an associated help page, see `mlr_terminators_[id]`.
...
[`trm()`](https://bbotk.mlr-org.com/reference/trm.md)/[`trms()`](https://bbotk.mlr-org.com/reference/trm.md).
...
Sugar functions: [`trm()`](https://bbotk.mlr-org.com/reference/trm.md),
[`trms()`](https://bbotk.mlr-org.com/reference/trm.md)
