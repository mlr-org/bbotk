...
when calling the
[Archive](https://bbotk.mlr-org.com/reference/Archive.md) methods
`$best()`, `$nds_selection()` and `$cols_y`. This class is usually
constructed internally from a
[paradox::ParamSet](https://paradox.mlr-org.com/reference/ParamSet.html)
when [Objective](https://bbotk.mlr-org.com/reference/Objective.md) is
initialized.
...
- [`Codomain$new()`](#method-Codomain-initialize)
