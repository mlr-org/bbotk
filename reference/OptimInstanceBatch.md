...
The function [`oi()`](https://bbotk.mlr-org.com/reference/oi.md) creates
an
...
[`oi()`](https://bbotk.mlr-org.com/reference/oi.md),
...
possible transformations to the input values and writes the results to
the [Archive](https://bbotk.mlr-org.com/reference/Archive.md).
