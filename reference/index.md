...
- [`bbotk`](https://bbotk.mlr-org.com/reference/bbotk-package.md)
  [`bbotk-package`](https://bbotk.mlr-org.com/reference/bbotk-package.md)
...
- [`mlr_terminators_clock_time`](https://bbotk.mlr-org.com/reference/mlr_terminators_clock_time.md)
  [`TerminatorClockTime`](https://bbotk.mlr-org.com/reference/mlr_terminators_clock_time.md)
...
- [`mlr_terminators_perf_reached`](https://bbotk.mlr-org.com/reference/mlr_terminators_perf_reached.md)
  [`TerminatorPerfReached`](https://bbotk.mlr-org.com/reference/mlr_terminators_perf_reached.md)
  : Performance Level Terminator
- [`mlr_terminators_run_time`](https://bbotk.mlr-org.com/reference/mlr_terminators_run_time.md)
  [`TerminatorRunTime`](https://bbotk.mlr-org.com/reference/mlr_terminators_run_time.md)
  : Run Time Terminator
- [`mlr_terminators_stagnation`](https://bbotk.mlr-org.com/reference/mlr_terminators_stagnation.md)
  [`TerminatorStagnation`](https://bbotk.mlr-org.com/reference/mlr_terminators_stagnation.md)
...
- [`mlr_terminators_stagnation_batch`](https://bbotk.mlr-org.com/reference/mlr_terminators_stagnation_batch.md)
  [`TerminatorStagnationBatch`](https://bbotk.mlr-org.com/reference/mlr_terminators_stagnation_batch.md)
  : Terminator that stops when optimization does not improve
- [`mlr_terminators_stagnation_hypervolume`](https://bbotk.mlr-org.com/reference/mlr_terminators_stagnation_hypervolume.md)
  [`TerminatorStagnationHypervolume`](https://bbotk.mlr-org.com/reference/mlr_terminators_stagnation_hypervolume.md)
...
- [`trm()`](https://bbotk.mlr-org.com/reference/trm.md)
  [`trms()`](https://bbotk.mlr-org.com/reference/trm.md) : Syntactic
  Sugar Terminator Construction
- [`as_terminator()`](https://bbotk.mlr-org.com/reference/as_terminator.md)
  [`as_terminators()`](https://bbotk.mlr-org.com/reference/as_terminator.md)
...
- [`OptimInstanceMultiCrit`](https://bbotk.mlr-org.com/reference/OptimInstanceMultiCrit.md)
  : Multi Criteria Optimization Instance for Batch Optimization
- [`OptimInstanceSingleCrit`](https://bbotk.mlr-org.com/reference/OptimInstanceSingleCrit.md)
  : Single Criterion Optimization Instance for Batch Optimization
- [`oi()`](https://bbotk.mlr-org.com/reference/oi.md) : Syntactic Sugar
  for Optimization Instance Construction
- [`oi_async()`](https://bbotk.mlr-org.com/reference/oi_async.md) :
...
- [`OptimizerBatch`](https://bbotk.mlr-org.com/reference/OptimizerBatch.md)
  : Batch Optimizer
- [`mlr_optimizers_async_design_points`](https://bbotk.mlr-org.com/reference/mlr_optimizers_async_design_points.md)
...
- [`mlr_optimizers_async_grid_search`](https://bbotk.mlr-org.com/reference/mlr_optimizers_async_grid_search.md)
  [`OptimizerAsyncGridSearch`](https://bbotk.mlr-org.com/reference/mlr_optimizers_async_grid_search.md)
  : Asynchronous Optimization via Grid Search
- [`mlr_optimizers_async_random_search`](https://bbotk.mlr-org.com/reference/mlr_optimizers_async_random_search.md)
  [`OptimizerAsyncRandomSearch`](https://bbotk.mlr-org.com/reference/mlr_optimizers_async_random_search.md)
  : Asynchronous Optimization via Random Search
- [`mlr_optimizers_chain`](https://bbotk.mlr-org.com/reference/mlr_optimizers_chain.md)
  [`OptimizerBatchChain`](https://bbotk.mlr-org.com/reference/mlr_optimizers_chain.md)
  : Run Optimizers Sequentially
- [`mlr_optimizers_cmaes`](https://bbotk.mlr-org.com/reference/mlr_optimizers_cmaes.md)
  [`OptimizerBatchCmaes`](https://bbotk.mlr-org.com/reference/mlr_optimizers_cmaes.md)
  : Optimization via Covariance Matrix Adaptation Evolution Strategy
- [`mlr_optimizers_design_points`](https://bbotk.mlr-org.com/reference/mlr_optimizers_design_points.md)
  [`OptimizerBatchDesignPoints`](https://bbotk.mlr-org.com/reference/mlr_optimizers_design_points.md)
  : Optimization via Design Points
- [`mlr_optimizers_focus_search`](https://bbotk.mlr-org.com/reference/mlr_optimizers_focus_search.md)
  [`OptimizerBatchFocusSearch`](https://bbotk.mlr-org.com/reference/mlr_optimizers_focus_search.md)
  : Optimization via Focus Search
- [`mlr_optimizers_gensa`](https://bbotk.mlr-org.com/reference/mlr_optimizers_gensa.md)
  [`OptimizerBatchGenSA`](https://bbotk.mlr-org.com/reference/mlr_optimizers_gensa.md)
  : Generalized Simulated Annealing
- [`mlr_optimizers_grid_search`](https://bbotk.mlr-org.com/reference/mlr_optimizers_grid_search.md)
  [`OptimizerBatchGridSearch`](https://bbotk.mlr-org.com/reference/mlr_optimizers_grid_search.md)
  : Optimization via Grid Search
- [`mlr_optimizers_irace`](https://bbotk.mlr-org.com/reference/mlr_optimizers_irace.md)
  [`OptimizerBatchIrace`](https://bbotk.mlr-org.com/reference/mlr_optimizers_irace.md)
  : Iterated Racing
- [`mlr_optimizers_local_search`](https://bbotk.mlr-org.com/reference/mlr_optimizers_local_search.md)
  [`OptimizerBatchLocalSearch`](https://bbotk.mlr-org.com/reference/mlr_optimizers_local_search.md)
  : Local Search
- [`mlr_optimizers_nloptr`](https://bbotk.mlr-org.com/reference/mlr_optimizers_nloptr.md)
  [`OptimizerBatchNLoptr`](https://bbotk.mlr-org.com/reference/mlr_optimizers_nloptr.md)
  : Non-linear Optimization
- [`mlr_optimizers_random_search`](https://bbotk.mlr-org.com/reference/mlr_optimizers_random_search.md)
  [`OptimizerBatchRandomSearch`](https://bbotk.mlr-org.com/reference/mlr_optimizers_random_search.md)
...
- [`opt()`](https://bbotk.mlr-org.com/reference/opt.md)
  [`opts()`](https://bbotk.mlr-org.com/reference/opt.md) : Syntactic
...
- [`Archive`](https://bbotk.mlr-org.com/reference/Archive.md) : Data
  Storage
...
- [`CallbackBatch`](https://bbotk.mlr-org.com/reference/CallbackBatch.md)
...
- [`callback_batch()`](https://bbotk.mlr-org.com/reference/callback_batch.md)
  : Create Batch Optimization Callback
- [`ContextAsync`](https://bbotk.mlr-org.com/reference/ContextAsync.md)
...
- [`bbotk.backup`](https://bbotk.mlr-org.com/reference/bbotk.backup.md)
...
- [`Progressor`](https://bbotk.mlr-org.com/reference/Progressor.md) :
  Progressor
- [`branin()`](https://bbotk.mlr-org.com/reference/branin.md)
  [`branin_wu()`](https://bbotk.mlr-org.com/reference/branin.md) :
  Branin Function
- [`bb_optimize()`](https://bbotk.mlr-org.com/reference/bb_optimize.md)
  : Black-Box Optimization
- [`shrink_ps()`](https://bbotk.mlr-org.com/reference/shrink_ps.md) :
  Shrink a ParamSet towards a point.
- [`bbotk_worker_loop()`](https://bbotk.mlr-org.com/reference/bbotk_worker_loop.md)
  : Worker loop for Rush
- [`trafo_xs()`](https://bbotk.mlr-org.com/reference/trafo_xs.md) :
  Calculate the transformed x-values
- [`terminated_error()`](https://bbotk.mlr-org.com/reference/terminated_error.md)
  : Termination Error
- [`error_bbotk()`](https://bbotk.mlr-org.com/reference/bbotk_conditions.md)
  [`error_bbotk_terminated()`](https://bbotk.mlr-org.com/reference/bbotk_conditions.md)
