...
test_that("on_optimization_begin works", {
  callback = callback_batch(id = "test", on_optimization_begin = function(callback, context) {
...
test_that("on_optimization_end works", {
  callback = callback_batch(id = "test", on_optimization_end = function(callback, context) {
    context$instance$terminator$param_set$values$n_evals = 20
  })
...
test_that("on_optimizer_before_eval works", {
  callback = callback_batch(id = "test", on_optimizer_before_eval = function(callback, context) {
...
test_that("on_optimizer_after_eval works", {
  callback = callback_batch(id = "test", on_optimizer_after_eval = function(callback, context) {
...
test_that("on_result_begin in OptimInstanceBatchSingleCrit works", {
  callback = callback_batch(id = "test", on_result_begin = function(callback, context) {
...
test_that("on_result_end in OptimInstanceBatchSingleCrit works", {
  callback = callback_batch(id = "test", on_result_end = function(callback, context) {
    context$result$y = 2
  })
...
test_that("on_result in OptimInstanceBatchSingleCrit works", {
  expect_warning(
    {
      callback = callback_batch(id = "test", on_result = function(callback, context) {
        context$result$y = 2
      })
    },
    "deprecated"
