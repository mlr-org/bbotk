...
#'
#' @description
#' Class to terminate the optimization after a given model evaluation budget is
#' exceeded. The terminator measures the used time to train and predict all
#' models contained in the archive.
#'
